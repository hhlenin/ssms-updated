            ...
            <tbody>
                @foreach ($courses as $course)
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                            <span class="tb-amount">{{ $course->teacher->name }}</span>
                        </td>
                    ...
                    ">
                        ...
                        <td class="nk-tb-col nk-tb-col-tools">
                            ...
                            <a href="{{ route('admin.courses.status-change', $course->id) }}" class="btn"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Change Status">
                                <i class="align-middle" data-feather="radio"></i>
                            </a>
                            <a href="{{ route('admin.courses.details', $course->id) }}" class="btn"
