                    ...
                    <div class="row gy-4">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" name="name" class="form-control" id="default-01"
                                        placeholder="" value="{{ $teacher->name }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" name="phone" class="form-control" id="default-01"
                                        placeholder="" value="{{ $teacher->phone }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <div class="custom-file">
                                        <img src="{{ asset($teacher->image) }}" width="120" height="120" style="object-fit: cover" alt="">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea name="address" class="form-control no-resize" id="default-textarea" rows="5">{{ $teacher->address }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" name="nid" class="form-control" id="default-01"
                                        placeholder="National Identification Number"  value="{{ $teacher->nid }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" name="district_id" class="form-control" id="default-01"
                                        placeholder=""  value="{{ $teacher->district }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="submit" class="btn btn-primary form-control"
                                        id="default-01" value="Save Teacher Informations">
                                </div>
